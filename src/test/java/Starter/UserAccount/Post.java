...
public class Post {
    ...
    public void requestPostDetailUser(String username, String password){
        ...
        if (username.equals("new")){
            ...
            try (FileWriter file = new FileWriter("src//test//resources//file_JSON//Username.json")) {
    ...
    public String getUserId(){
        ...
        try (FileWriter file = new FileWriter("src//test//resources//file_JSON//UserID.json")) {
            file.write(userId);
            file.flush();
        } catch (IOException e) {
            e.printStackTrace();
